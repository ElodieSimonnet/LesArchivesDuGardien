...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $sql = "INSERT INTO adg_pets (name, description, image, id_family, id_source, id_expansion, id_faction, droprate, cost, id_zone, id_currency, id_target, spell_1, spell_2, spell_3, spell_4, spell_5, spell_6)
                VALUES (:name, :description, :image, :id_family, :id_source, :id_expansion, :id_faction, :droprate, :cost, :id_zone, :id_currency, :id_target, :spell_1, :spell_2, :spell_3, :spell_4, :spell_5, :spell_6)";
