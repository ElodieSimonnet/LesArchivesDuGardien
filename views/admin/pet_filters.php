            ...
            <div class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                ...
                <div id="admin-pet-filters-family" class="mobile-accordion-content px-6 pb-6 space-y-3">
                    ...
                    <label class="flex items-center justify-between p-4 bg-amber-500/15 border-l-4 border-primary-orange rounded-r-lg cursor-pointer active:bg-amber-500/30 transition-all text-sm font-bold uppercase italic text-primary-white">
                        <?= htmlspecialchars($familyItem['family']) ?>
                        <input type="checkbox" name="family[]" value="<?= htmlspecialchars($familyItem['family']) ?>" <?= in_array(strtolower($familyItem['family']), array_map('strtolower', $currentFamilies)) ? 'checked' : '' ?> class="filter-checkbox accent-primary-orange w-6 h-6">
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                ...
                <div id="admin-pet-filters-source" class="mobile-accordion-content hidden px-6 pb-6 space-y-3">
                    ...
                    <label class="flex items-center justify-between p-4 bg-amber-500/15 border-l-4 border-primary-orange rounded-r-lg cursor-pointer transition-all text-sm font-bold uppercase italic text-primary-white">
                        ...
                        <input type="checkbox" name="source[]" value="<?= htmlspecialchars($sourceItem['source']) ?>" <?= in_array(strtolower($sourceItem['source']), array_map('strtolower', $currentPetSources)) ? 'checked' : '' ?> class="filter-checkbox accent-primary-orange w-6 h-6">
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                ...
                <div id="admin-pet-filters-extension" class="mobile-accordion-content hidden px-6 pb-6 space-y-3">
                    ...
                    <label class="flex items-center justify-between p-4 bg-amber-500/15 border-l-4 border-primary-orange rounded-r-lg cursor-pointer transition-all text-sm font-bold uppercase italic text-primary-white">
                        ...
                        <input type="checkbox" name="expansion[]" value="<?= htmlspecialchars($expansionItem['expansion']) ?>" <?= in_array(strtolower($expansionItem['expansion']), array_map('strtolower', $currentPetExpansions)) ? 'checked' : '' ?> class="filter-checkbox accent-primary-orange w-6 h-6">
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                ...
                <div id="admin-pet-filters-faction" class="mobile-accordion-content hidden px-6 pb-6 space-y-3">
                    ...
                    <label class="flex items-center justify-between p-4 bg-amber-500/15 border-l-4 border-primary-orange rounded-r-lg cursor-pointer transition-all text-sm font-bold uppercase italic text-primary-white">
                        ...
                        <input type="checkbox" name="faction[]" value="<?= htmlspecialchars($factionItem['faction']) ?>" <?= in_array(strtolower($factionItem['faction']), array_map('strtolower', $currentPetFactions)) ? 'checked' : '' ?> class="filter-checkbox accent-primary-orange w-6 h-6">
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
