...
<div id="filter-mobile-menu" role="dialog" aria-modal="true" aria-label="Filtres" aria-hidden="true" class="fixed inset-y-0 right-0 z-[501] w-full md:hidden bg-primary-black transform translate-x-full transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] flex flex-col border-l border-primary-orange shadow-2xl">
    ...
    <div class="flex-1 overflow-y-auto px-6 py-8">
        ...
        <div class="space-y-4">
            ...
            <section class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                <button type="button" class="mobile-accordion-header w-full px-6 py-5 flex justify-between items-center group" aria-expanded="false" aria-controls="filter-type-content">
                    <span class="text-primary-orange uppercase font-bold tracking-widest text-base flex items-center gap-3">
                ...
                <div id="filter-type-content" class="mobile-accordion-content hidden px-6 pb-6 space-y-3">
