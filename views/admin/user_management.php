...
<body class="bg-black">
    ...
    <main id="main-content" class="flex-1 min-h-screen overflow-y-auto bg-[url(../images/lava_cave_mob.webp)] bg-cover bg-center bg-fixed md:bg-[url(../images/lava_cave_without_f2_tab.webp)] lg:bg-[url(../images/lava_cave_without_f2.webp)] text-primary-white font-sans p-4 xl:p-8 lg:ml-64">
        ...
        <div class="flex justify-center mb-10 mt-4">
            ...
            <div role="table" aria-label="Liste des utilisateurs" class="w-full border border-primary-orange rounded-lg bg-[#1a0f0a] overflow-hidden">
                ...
                <div role="rowgroup" class="flex flex-col divide-y divide-amber-900/20">
                    <?php foreach ($all_users as $userRow) : ?>
                        <div role="row" data-username="<?= htmlspecialchars(strtolower($userRow['username'])) ?>" data-email="<?= htmlspecialchars(strtolower($userRow['email'])) ?>" class="user-row flex flex-col xl:grid xl:grid-cols-12 bg-row-dark xl:items-stretch border-b border-primary-orange gap-3 xl:gap-0 p-5 xl:p-0 hover:bg-amber-500/5 transition-all group">
    ...
    <script src="../assets/js/admin-user-filters.js"></script>
    <script>
