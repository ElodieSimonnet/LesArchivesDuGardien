<dialog id="loginModal" aria-labelledby="loginModalTitle"
    ...
    <button id="loginModalClose" type="button" class="absolute top-4 right-4 text-a11y-gray hover:text-primary-orange text-4xl cursor-pointer" aria-label="Fermer la fenêtre de connexion">&times;</button>
    ...
    <div id="loginError" role="alert" aria-live="assertive" class="hidden bg-red-900/50 border border-red-500 text-red-200 p-3 rounded mb-4 text-sm text-center"></div>
...
<dialog id="registerModal" aria-labelledby="registerModalTitle"
    ...
    <button id="registerModalClose" type="button" class="absolute top-4 right-4 text-a11y-gray hover:text-primary-orange text-4xl cursor-pointer" aria-label="Fermer la fenêtre d'inscription">&times;</button>
    ...
    <div id="registerError" role="alert" aria-live="assertive" class="hidden bg-red-900/50 border border-red-500 text-red-200 p-3 rounded mb-4 text-sm text-center"></div>
    ...
    <form id="registerForm" class="space-y-4">
        ...
        <div class="flex items-start gap-3">
            <input type="checkbox" name="consent" id="consent" required
                class="mt-1 w-4 h-4 accent-primary-orange cursor-pointer shrink-0">
            <label for="consent" class="text-sm text-gray-300 leading-snug cursor-pointer">
                J'ai lu et j'accepte la <a href="legals.php" target="_blank" class="text-primary-orange hover:underline">politique de confidentialité</a> et les mentions légales.
            </label>
        </div>
