...
<div class="p-6 flex flex-col items-center">
          <nav class="w-full space-y-8 mt-4" aria-label="Navigation administration">
            <a href="dashboard_admin.php" <?php echo ($currentPage === 'dashboard_admin.php') ? 'aria-current="page"' : ''; ?> class="flex items-center gap-3 p-3 <?php echo ($currentPage === 'dashboard_admin.php') ? 'bg-amber-900/20 text-primary-orange border-l-4 border-primary-orange' : 'text-amber-600/60 hover:text-primary-orange transition-all'; ?> uppercase text-xs font-bold tracking-widest">
            ...
            <a href="admin_user_gestion.php" <?php echo ($currentPage === 'admin_user_gestion.php') ? 'aria-current="page"' : ''; ?> class="flex items-center gap-3 p-3 <?php echo ($currentPage === 'admin_user_gestion.php') ? 'bg-amber-900/20 text-primary-orange border-l-4 border-primary-orange' : 'text-amber-600/60 hover:text-primary-orange transition-all'; ?> uppercase text-xs font-bold tracking-widest">
            ...
            <a href="admin_mount_gestion.php" <?php echo ($currentPage === 'admin_mount_gestion.php') ? 'aria-current="page"' : ''; ?> class="flex items-center gap-3 p-3 <?php echo ($currentPage === 'admin_mount_gestion.php') ? 'bg-amber-900/20 text-primary-orange border-l-4 border-primary-orange' : 'text-amber-600/60 hover:text-primary-orange transition-all'; ?> uppercase text-xs font-bold tracking-widest">
            ...
            <a href="admin_pet_gestion.php" <?php echo ($currentPage === 'admin_pet_gestion.php') ? 'aria-current="page"' : ''; ?> class="flex items-center gap-3 p-3 <?php echo ($currentPage === 'admin_pet_gestion.php') ? 'bg-amber-900/20 text-primary-orange border-l-4 border-primary-orange' : 'text-amber-600/60 hover:text-primary-orange transition-all'; ?> uppercase text-xs font-bold tracking-widest">
            ...
            <a href="admin_news_gestion.php" <?php echo ($currentPage === 'admin_news_gestion.php') ? 'aria-current="page"' : ''; ?> class="flex items-center gap-3 p-3 <?php echo ($currentPage === 'admin_news_gestion.php') ? 'bg-amber-900/20 text-primary-orange border-l-4 border-primary-orange' : 'text-amber-600/60 hover:text-primary-orange transition-all'; ?> uppercase text-xs font-bold tracking-widest">
            ...
            <a href="admin_faq_gestion.php" <?php echo ($currentPage === 'admin_faq_gestion.php') ? 'aria-current="page"' : ''; ?> class="flex items-center gap-3 p-3 <?php echo ($currentPage === 'admin_faq_gestion.php') ? 'bg-amber-900/20 text-primary-orange border-l-4 border-primary-orange' : 'text-amber-600/60 hover:text-primary-orange transition-all'; ?> uppercase text-xs font-bold tracking-widest">
