        ...
        <form id="filterForm" class="space-y-4">
            ...
            <div class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                ...
                <div class="mobile-accordion-content px-6 pb-6 space-y-3">
                    ...
                    <label class="flex items-center justify-between p-4 bg-amber-500/15 border-l-4 border-primary-orange rounded-r-lg cursor-pointer active:bg-amber-500/30 transition-all text-sm font-bold uppercase italic text-primary-white">
                        ...
                        <input type="checkbox" name="type[]" value="<?php echo htmlspecialchars($typeItem['type']); ?>" <?php echo in_array(strtolower($typeItem['type']), array_map('strtolower', $currentTypes)) ? 'checked' : ''; ?> class="filter-checkbox accent-primary-orange w-6 h-6">
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                ...
                <div class="mobile-accordion-content hidden px-6 pb-6 space-y-3">
                    ...
                    <label class="flex items-center justify-between p-4 bg-amber-500/15 border-l-4 border-primary-orange rounded-r-lg cursor-pointer transition-all text-sm font-bold uppercase italic text-primary-white">
                        ...
                        <input type="checkbox" name="source[]" value="<?php echo htmlspecialchars($sourceItem['source']); ?>" <?php echo in_array(strtolower($sourceItem['source']), array_map('strtolower', $currentSources)) ? 'checked' : ''; ?> class="filter-checkbox accent-primary-orange w-6 h-6">
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                ...
                <div class="mobile-accordion-content hidden px-6 pb-6 space-y-3">
                    ...
                    <label class="flex items-center justify-between p-4 bg-amber-500/15 border-l-4 border-primary-orange rounded-r-lg cursor-pointer transition-all text-sm font-bold uppercase italic text-primary-white">
                        ...
                        <input type="checkbox" name="expansion[]" value="<?php echo htmlspecialchars($expansionItem['expansion']); ?>" <?php echo in_array(strtolower($expansionItem['expansion']), array_map('strtolower', $currentExpansions)) ? 'checked' : ''; ?> class="filter-checkbox accent-primary-orange w-6 h-6">
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                ...
                <div class="mobile-accordion-content hidden px-6 pb-6 space-y-3">
                    ...
                    <label class="flex items-center justify-between p-4 bg-amber-500/15 border-l-4 border-primary-orange rounded-r-lg cursor-pointer transition-all text-sm font-bold uppercase italic text-primary-white">
                        ...
                        <input type="checkbox" name="faction[]" value="<?php echo htmlspecialchars($factionItem['faction']); ?>" <?php echo in_array(strtolower($factionItem['faction']), array_map('strtolower', $currentFactions)) ? 'checked' : ''; ?> class="filter-checkbox accent-primary-orange w-6 h-6">
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="filter-section border border-primary-orange rounded-xl overflow-hidden bg-primary-brown">
                ...
                <div class="mobile-accordion-content hidden px-6 pb-6 space-y-3">
                    ...
                    <label class="flex items-center justify-between p-4 bg-amber-500/15 border-l-4 border-primary-orange rounded-r-lg cursor-pointer transition-all text-sm font-bold uppercase italic text-primary-white">
                        <?php echo htmlspecialchars($difficultyItem['difficulty']); ?>
                        <input type="checkbox" name="difficulty[]" value="<?php echo htmlspecialchars($difficultyItem['difficulty']); ?>" <?php echo in_array(strtolower($difficultyItem['difficulty']), array_map('strtolower', $currentDifficulties)) ? 'checked' : ''; ?> class="filter-checkbox accent-primary-orange w-6 h-6">
                    </label>
                    <?php endforeach; ?>
                </div>
            </div>
