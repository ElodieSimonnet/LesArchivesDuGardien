...
<body class="bg-black">
        ...
        <div class="flex justify-center mb-10 mt-4">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-4 mb-6 bg-admin-dark p-3 border-t border-b border-primary-orange">
                <div class="xl:col-span-6 relative">
                    ...
                    <input type="text" id="search-pet" placeholder="Rechercher une mascotte" aria-label="Rechercher une mascotte" class="w-full bg-black/40 border border-primary-orange/70 rounded-md py-2 pl-10 pr-4 text-sm focus:outline-none focus:border-primary-orange text-amber-100">
                </div>
            ...
            <div role="table" aria-label="Liste des mascottes" class="w-full border border-primary-orange rounded-lg bg-admin-dark overflow-hidden">
                ...
                <div role="rowgroup" class="flex flex-col divide-y divide-amber-900/20">
                    <?php foreach ($all_pets as $i => $petRow) : ?>
                        <div role="row" data-name="<?= htmlspecialchars(strtolower($petRow['name'])) ?>" class="pet-row flex flex-col xl:grid xl:grid-cols-12 <?= $i % 2 === 0 ? 'bg-row-dark' : 'bg-row-light' ?> xl:items-stretch border-b border-primary-orange gap-3 xl:gap-0 p-5 xl:p-0 hover:bg-amber-500/5 transition-all group">
                            ...
                            <div role="cell" class="xl:col-span-1 xl:p-4 flex justify-between xl:justify-center items-center xl:border-r xl:border-primary-orange border-dashed">
                                ...
                                <span class="font-bold text-primary-white">#<?= htmlspecialchars($petRow['id']) ?></span>
                            </div>
                            ...
                            <div role="cell" class="xl:col-span-3 xl:p-4 flex justify-between xl:justify-center items-center xl:border-r xl:border-primary-orange border-dashed">
                                ...
                                <span class="font-bold text-primary-white text-sm"><?= htmlspecialchars($petRow['name']) ?></span>
                            </div>
                            ...
                            <div role="cell" class="xl:col-span-2 xl:p-4 flex justify-between xl:justify-center items-center xl:border-r xl:border-primary-orange border-dashed">
                                ...
                                <span class="text-sm text-primary-white font-black uppercase">
                                    <?= htmlspecialchars($petRow['family']) ?>
                                </span>
                            </div>
                            ...
                            <div role="cell" class="xl:col-span-2 xl:p-4 flex justify-between xl:justify-center items-center xl:border-r xl:border-primary-orange border-dashed">
                                ...
                                <span class="text-sm text-primary-white text-center">
                                    <?= htmlspecialchars($petRow['source']) ?>
                                </span>
                            </div>
                            ...
                            <div role="cell" class="xl:col-span-2 xl:p-4 flex justify-between xl:justify-center items-center xl:border-r xl:border-primary-orange border-dashed">
                                ...
                                <span class="text-sm text-primary-white text-center">
                                    <?= htmlspecialchars($petRow['expansion']) ?>
                                </span>
                            </div>

                            <div role="cell" class="xl:col-span-2 xl:p-4 flex justify-end xl:justify-center items-center gap-3">
                                <a href="view_pet.php?id=<?= $petRow['id'] ?>" class="p-2 border border-primary-orange rounded text-primary-orange hover:bg-primary-orange hover:text-black transition-all" title="Voir" aria-label="Voir <?= htmlspecialchars($petRow['name']) ?>">
                                    <i class="ph ph-eye text-2xl" aria-hidden="true"></i>
                                </a>
                                <a href="edit_pet.php?id=<?= $petRow['id'] ?>" class="p-2 border border-primary-orange rounded text-primary-orange hover:bg-primary-orange hover:text-black transition-all" title="Modifier" aria-label="Modifier <?= htmlspecialchars($petRow['name']) ?>">
                                    <i class="ph ph-pencil-simple text-2xl" aria-hidden="true"></i>
                                </a>
                                <form action="delete_pet.php" method="POST" class="delete-form inline">
                                    <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
                                    <input type="hidden" name="pet_id" value="<?= $petRow['id'] ?>">
                                    <button type="submit" class="p-2 border border-primary-orange rounded text-primary-orange hover:bg-red-600 transition-all hover:border-none hover:text-black cursor-pointer" title="Supprimer" aria-label="Supprimer <?= htmlspecialchars($petRow['name']) ?>">
    ...
    <?php require __DIR__ . '/pet_filters.php'; ?>
    <script src="../assets/js/admin-pet-filters.js" defer></script>
    <script src="../assets/js/admin-pet-management.js" defer></script>
