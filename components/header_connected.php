    ...
    <nav class="max-w-full mx-auto flex items-center" aria-label="Navigation principale">
        <div class="flex items-center lg:flex-1">
            ...
            <ul class="hidden lg:flex items-center gap-12 ml-8 text-primary-white font-semibold uppercase text-lg tracking-wider">
                ...
                <li><a href="transmo_list.php" class="hover:text-primary-orange transition-colors">Apparences</a></li>
            </ul>
        </div>
        ...
        <div class="flex items-center justify-end gap-4 mr-6 lg:flex-none">
            <div class="hidden lg:flex gap-6">
                <a href="logout.php" class="bg-primary-orange text-primary-black font-bold py-2 px-6 rounded uppercase text-lg hover:bg-amber-500 transition-all shadow-md">Déconnexion</a>
            </div>

            <a href="profile.php" class="lg:hidden p-2 border-2 border-primary-orange rounded-xl text-primary-orange" aria-label="Mon Profil">
